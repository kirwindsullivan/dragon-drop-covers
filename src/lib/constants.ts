...
export const CAMERA_PRESETS = [
  {
    id:          "hero",
    position:    [1.2,  0.6,  8.5] as [number, number, number],
...
export const SCALE_MAP: Record<BookSize, [number, number, number]> = {
  hardcover: [0.14, 0.14, 0.14],
  softcover: [0.14, 0.14, 0.09],
  digest:    [0.12, 0.13, 0.07],
  zine:      [0.12, 0.13, 0.025],
  letter:    [0.17, 0.19, 0.14],
};
...
export const HARDCOVER_FRONT_UV: FrontUVBounds = {
  ...
  vMin: 0.520, vMax: 0.965, // tuned: 0.509→0.495→0.520 — corrects cover-too-high offset
};
